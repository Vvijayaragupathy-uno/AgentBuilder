...
import AiccoreLogo from "@/assets/AiccoreLogo.svg?react";
...
export default function AppHeader(): JSX.Element {
  ...
  return (
    <div
      className={`z-10 flex h-[48px] w-full items-center justify-between border-b pr-5 pl-2.5 premium-glass !bg-background/40`}
    ...
    >
      ...
      >
        ...
        >
          <AiccoreLogo className="h-5 w-5" title="AICCORE Makerspace" />
        </Button>
        <CustomOrgSelector />
      </div>
